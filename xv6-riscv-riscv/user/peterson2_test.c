...
// Assume these are implemented in the kernel and accessible via syscall wrappers
extern int peterson_create(void);
extern int peterson_acquire(int lock_id, int role);
extern int peterson_release(int lock_id, int role);
extern int peterson_destroy(int lock_id);
